...
| モジュール | ユニットテスト数 | 統合テスト数 | 合計 |
|-----------|:---:|:---:|:---:|
| `packet/` (mod, header, serialization, config, flags, payload) | 36 | 0 | 36 |
| `core/` | 4 | 0 | 4 |
| `lib.rs` | 4 | 0 | 4 |
| `network/` (server, context) | 5 | 0 | 5 |
| `parser/` + `codegen/` | 0 | 5 | 5 |
| `context/` (CGP) | 0 | 1 | 1 |
| Identity | 0 | 2 | 2 |
| QUIC transport | 0 | 2 | 2 |
| **合計** | **49** | **10** | **59** |
